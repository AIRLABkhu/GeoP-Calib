...
class CalibrateGaussianListModel:
    ...
    def load_ply(self, path):
        ...
        self._opacity = nn.Parameter(self.inverse_opacity_activation(torch.tensor(opacities, dtype=torch.float, device="cuda")).requires_grad_(True))
        ...
        print(f"Successfully loaded {self._xyz.shape[0]} gaussians from {path}")
